            ...
            <form method="POST" enctype="multipart/form-data" class="space-y-10">
                ...
                <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" name="rcNumber" id="rcNumber" placeholder="Enter RC number" value="<?= isset($_POST['rcNumber']) ? htmlspecialchars($_POST['rcNumber']) : ($editMode ? htmlspecialchars($applicationData['rc_number']) : '') ?>" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500" oninput="this.value = this.value.toUpperCase()">
                                <button type="button" id="rcLookupBtn" class="absolute inset-y-0 right-0 px-4 flex items-center text-sm font-medium text-white bg-purple-600 rounded-r-lg hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="engineNumber" id="engineNumber" placeholder="Enter 5-digit engine number" maxlength="5" value="<?= isset($_POST['engineNumber']) ? htmlspecialchars($_POST['engineNumber']) : ($editMode ? htmlspecialchars($applicationData['engine_number']) : '') ?>" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-600 mb-2">Chassis Number (5 digits) *</label>
                            <input type="text" name="chassisNumber" id="chassisNumber" placeholder="Enter 5-digit chassis number" maxlength="5" value="<?= isset($_POST['chassisNumber']) ? htmlspecialchars($_POST['chassisNumber']) : ($editMode ? htmlspecialchars($applicationData['chassis_number']) : '') ?>" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500">
                        </div>
                        <div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div id="lenderInputWrap" class="mt-4 hidden" style="position: relative; z-index: 10;">
                ...
                <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                    ...
                    <div class="space-y-8">
                        <div>
                            ...
                            <div class="flex space-x-4">
                                <?php foreach (['Self' => 'Self (Channel)', 'RTO Agent' => 'RTO Agent', 'Banker' => 'Banker'] as $value => $label): ?>
                                    <label class="flex items-center">
                                        <input type="radio" name="rcCollectionMethod" value="<?= $value ?>" class="mr-2 text-purple-600 focus:ring-purple-500" onchange="toggleChannelInputs()" <?= ($editMode && $applicationData['rc_collection_method'] === $value) || (!$editMode && $value === 'Self') ? 'checked' : '' ?>>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- RC Front Upload -->
                            <div class="border-2 border-dashed border-purple-300 rounded-lg p-6 text-center cursor-pointer hover:border-purple-500 transition-colors" onclick="document.getElementById('rcFrontInput').click()">
                                <input type="file" id="rcFrontInput" name="rcFront" accept="image/*,.pdf" class="hidden" onchange="previewImage(event, 'rcFrontPreview', 'rcFrontIcon')">
                                <div class="mb-4">
                                    <img id="rcFrontPreview" src="" alt="RC Front Preview" class="mx-auto h-24 w-auto object-contain rounded shadow-sm hidden" />
                                    <i id="rcFrontIcon" class="fas fa-image mx-auto h-12 w-12 text-gray-400"></i>
                                </div>
                                <h4 class="font-medium text-gray-700">RC Front Side</h4>
                                <p class="text-xs text-gray-500 mt-1">Front side with vehicle details</p>
                                <span class="mt-4 inline-block text-sm font-medium text-purple-600">Choose File</span>
                            </div>
                            <!-- RC Back Upload -->
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center cursor-pointer hover:border-purple-500 transition-colors" onclick="document.getElementById('rcBackInput').click()">
                                <input type="file" id="rcBackInput" name="rcBack" accept="image/*,.pdf" class="hidden" onchange="previewImage(event, 'rcBackPreview', 'rcBackIcon')">
                                <div class="mb-4">
                                    <img id="rcBackPreview" src="" alt="RC Back Preview" class="mx-auto h-24 w-auto object-contain rounded shadow-sm hidden" />
                                    <i id="rcBackIcon" class="fas fa-image mx-auto h-12 w-12 text-gray-400"></i>
                                </div>
                                <h4 class="font-medium text-gray-700">RC Back Side</h4>
                                <p class="text-xs text-gray-500 mt-1">Back side with owner details</p>
                                <span class="mt-4 inline-block text-sm font-medium text-purple-600">Choose File</span>
                            </div>
                        </div>
                    </div>
